                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('team-edit')
                                        <a class="btn btn-primary btn-sm" onclick="return confirm('Are you sure to edit this record?')" href="{{ route('teams.edit',dEncrypt($teams->id)) }}"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                        @endcan
