                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @can('role-edit')
                                            <a class="btn btn-primary btn-sm" onclick="return confirm('Are you sure to edit this record?')" href="{{ route('roles.edit', dEncrypt($role->id)) }}"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                            @endcan
