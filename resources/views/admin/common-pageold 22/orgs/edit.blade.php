                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" minlength="3" maxlength="30"
                                                placeholder="enter logo title" name="header_logo_title"
                                                value="{{ $org->header_logo_title ?? '' }}"
                                                class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="favicon_title" minlength="3" maxlength="30"
                                                placeholder="enter favicon title" value="{{ $org->favicon_title ?? '' }}"
                                                class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="header_logo_title" minlength="3" maxlength="30"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>Map:</strong>
                                            <input type="text" minlength="3" maxlength="400"
                                                placeholder="Enter Map Path" name="map"
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="instagram" placeholder="enter instagram url"
                                                value="{{ $org->instagram ?? '' }}" placeholder="instagram"
                                                minlength="3" maxlength="100" class="form-control ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="facebook" value="{{ $org->facebook ?? '' }}"
                                                minlength="3" maxlength="100" placeholder="Facebook"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="facebook_title"
                                                ...
                                                minlength="3" maxlength="100" class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="youtube" placeholder="youtube" minlength="3"
                                                maxlength="100" value="{{ $org->youtube ?? '' }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="number_count1"
                                                placeholder="Enter First count Number" minlength="1" maxlength="3"
                                                value="{{ $org->number_count1 ?? '' }}" class="form-control mobile_no">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="unit_count1" placeholder="Enter First count Unit"
                                                minlength="1" maxlength="8" value="{{ $org->unit_count1 ?? '' }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="text_count1" placeholder="Enter First count Text"
                                                minlength="1" maxlength="30" value="{{ $org->text_count1 ?? '' }}"
                                                class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="number_count2"
                                                ...
                                                value="{{ $org->number_count2 ?? '' }}" class="form-control mobile_no">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="number_count3"
                                                placeholder="Enter Third count Number" minlength="1" maxlength="3"
                                                value="{{ $org->number_count3 ?? '' }}" class="form-control mobile_no">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="unit_count3" placeholder="Enter Third count Unit"
                                                minlength="1" maxlength="8" value="{{ $org->unit_count3 ?? '' }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="text_count3" placeholder="Enter Third count Text"
                                                minlength="1" maxlength="30" value="{{ $org->text_count3 ?? '' }}"
                                                class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="number_count4"
                                                ...
                                                value="{{ $org->number_count4 ?? '' }}" class="form-control mobile_no">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="count_heading" minlength="3" maxlength="100"
                                                value="{{ $org->count_heading ?? '' }}"
                                                class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="count_phone" minlength="10" maxlength="10"
                                                value="{{ $org->count_phone ?? '' }}" class="form-control mobile_no">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="specialities_title" minlength="3"
                                                maxlength="30" value="{{ $org->specialities_title ?? '' }}"
                                                class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="specialities_heading" minlength="3"
                                                maxlength="100" value="{{ $org->specialities_heading ?? '' }}"
                                                class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="team_title" minlength="3" maxlength="30"
                                                value="{{ $org->team_title ?? '' }}" class="form-control preventnumeric">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="team_phone" minlength="10" maxlength="10"
                                                value="{{ $org->team_phone ?? '' }}" placeholder="phone"
                                                class="form-control mobile_no">
                                        </div>
                                    </div>
