                    ...
                    <form method="POST" action="{{ route('banners.update',dEncrypt($banner->id)) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Url:</strong>
                                    <input type="text" name="url" placeholder="url" minlength="3"  maxlength="100" value="{{ $banner->url  ??''}}" class="form-control">
                                    @error('url')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" class="form-control image" @if($banner->image)
                                    value="{{$banner->image}}"
                                    @endif>
                                </div>
                                @error('image')
