                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="meta_title" minlength="3"
                                                maxlength="100" placeholder="Please enter meta tittle, use for seo"
                                                value="{{ old('meta_title') }}" class="form-control preventnumeric">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="keyword" rows="4" class="form-control" name="meta_keyword"
                                                placeholder="Please enter meta keywords, use for seo">{!! old('meta_keyword') !!}</textarea>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="banner" placeholder="content Image"
                                                class="form-control">
                                    ...
                                    <!-- Content Description -->
                                    <div class="col-xs-12 col-sm-12 col-md-12" id="contentDescription"
                                        style="display: none;">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12" id="contentImage" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" placeholder="content Image"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <!-- Content Description -->
                                    <div class="col-xs-12 col-sm-12 col-md-12" id="contentDescription2"
                                        style="display: none;">
                                        <div class="form-group">
                                            <strong>Content Description:</strong>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12" id="contentImage2" style="display: none;">
                                        <div class="form-group">
                                            <strong>Content Image:</strong>
                                            <input type="file" name="image2" placeholder="content Image"
                                                class="form-control">
                                        </div>
                                    </div>
