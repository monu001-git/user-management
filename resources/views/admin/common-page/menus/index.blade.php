                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('menu-edit')
                                        <a class="btn btn-primary btn-sm" onclick="return confirm('Are you sure to edit this record?')" href="{{ route('menus.edit',dEncrypt($menus->id)) }}"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                        @endcan
