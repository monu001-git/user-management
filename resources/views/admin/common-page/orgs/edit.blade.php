                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="header_logo" class="form-control" @if ($org->header_logo) value="{{ $org->header_logo }}" @endif>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="favicon" class="form-control" @if ($org->favicon) value="{{ $org->favicon }}" @endif>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="footer_logo" class="form-control" @if ($org->footer_logo) value="{{ $org->footer_logo }}" @endif>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="youtube_title"  value="{{ $org->youtube_title ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count1" placeholder="enter number" value="{{ $org->number_count1 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unit_count1"  placeholder="enter value" value="{{ $org->unit_count1 ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text_count1" placeholder="enter text" value="{{ $org->text_count1 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count2" value="{{ $org->number_count2 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unit_count2" value="{{ $org->unit_count2 ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text_count2" value="{{ $org->text_count2 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count3" value="{{ $org->number_count3 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unit_count3" value="{{ $org->unit_count3 ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text_count3" value="{{ $org->text_count3 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count4" value="{{ $org->number_count4 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unit_count4" value="{{ $org->unit_count4 ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text_count4" value="{{ $org->text_count4 ?? '' }}"  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="count_heading" value="{{ $org->count_heading ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <strong>Count phone:</strong>
                                        <input type="text" name="count_phone" value="{{ $org->count_phone ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="specialities_title" value="{{ $org->specialities_title ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="specialities_heading" value="{{ $org->specialities_heading ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="specialities_phone" placeholder="phone" value="{{ $org->specialities_phone }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="team_title" value="{{ $org->team_title ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="team_heading" value="{{ $org->team_heading ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="team_phone" value="{{ $org->team_phone ?? '' }}" placeholder="phone" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="news_title" value="{{ $org->news_title ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="news_heading" value="{{ $org->news_heading ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="middle_image" class="form-control" @if ($org->middle_image) value="{{ $org->middle_image }}" @endif>
