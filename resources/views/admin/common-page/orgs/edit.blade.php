                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count1" value="{{ $org->number_count1 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text_count1" value="{{ $org->text_count1 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unit_count1" value="{{ $org->unit_count1 ??''  }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count2" value="{{ $org->number_count2 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <strong>Count text 2 :</strong>
                                        <input type="text" name="text_count2" value="{{ $org->text_count2 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count3" value="{{ $org->number_count3 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <strong>Count text 3 :</strong>
                                        <input type="text" name="text_count3" value="{{ $org->text_count3 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_count4" value="{{ $org->number_count4 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text_count4" value="{{ $org->text_count4 ??''}}" placeholder="youtube title" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="middle_image" class="form-control" @if($org->middle_image)
                                        value="{{$org->middle_image}}"
                                        @endif>
