...
@section('content')
    ...
    @if (isset($content->banner) && $content->banner != null)
        ...
        <section class="wpo-page-title"
            style="background: url( {{ asset('uploads/banner/' . $content->banner) }}) no-repeat center top/cover;">
            <div class="container">
                <div class="row">
    ...
    @if (isset($message))
        <div class="wpo-service-single-area section-paddingg">
            <div class="container">
                <h1> {{ $message ?? '' }}</h1>
            </div>
        </div>
    ...
    @if (
        (isset($content->left_right) && $content->left_right == 'on') ||
            (isset($content->center_content) && $content->center_content == 'on'))
    ...
    {{-- content left start --}}
    @if ((isset($content->right_left) && $content->right_left == 'on') || (isset($content->faq) && $content->faq == 'on'))
                                                                ...
                                                                <div class="accordion-item">
                                                                    <h2 class="accordion-header"
                                                                        ...
                                                                        <button class="accordion-button" type="button"
                                                                            ...
                                                                            data-bs-target="#panelsStayOpen-collapse{{ $k }}"
                                                                            aria-expanded="true"
                                                                    ...
                                                                    <div id="panelsStayOpen-collapse{{ $k }}"
            ...
            <div class="container new-width">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                        <div class="counter-box">
                            <div class="info">
                                <h3>
                                    <span class="odometer number"
                                        data-count="{{ $orgData->number_count1 ?? '' }}">00</span>{{ $orgData->unit_count1 ?? '' }}
                                </h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                        <div class="counter-box">
                            <div class="info">
                                <h3>
                                    <span class="odometer number"
                                        data-count="{{ $orgData->number_count2 ?? '' }}">00</span>{{ $orgData->unit_count2 ?? '' }}
                                </h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                        <div class="counter-box">
                            <div class="info">
                                <h3>
                                    <span class="odometer number"
                                        data-count="{{ $orgData->number_count3 ?? '' }}">00</span>{{ $orgData->unit_count3 ?? '' }}
                                </h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                        <div class="counter-box">
                            <div class="info">
                                <h3>
                                    <span class="odometer number"
                                        data-count="{{ $orgData->number_count4 ?? '' }}">00</span>{{ $orgData->unit_count4 ?? '' }}
                                </h3>
                ...
                <div class="row justify-content-center subtitle-white">
                    <div class="col-xl-7 col-lg-7 col-md-7 col-12 text-center">
                        ...
                        <a href="tel:{{ $orgData->count_phone ?? '' }}"><img
                    ...
                    <div class="gallery-masonry-block">
                        <div class="gallery-masonry-item-wrap gallery-masonry">
                            @foreach ($organizedData['image'] as $imageContent)
                                <div class="column column-4 gallery-masonry-item"
                                    data-src="{{ asset('uploads/content/image' . '/' . $imageContent->image) }}">
                                    <img src="{{ asset('uploads/content/image' . '/' . $imageContent->image) }}"
                                        alt="" class="gallery-item">
                                </div>
                            @endforeach
                        </div>
                    </div>
                                            ...
                                            <div class="team-single">
                                                <div class="team-boder-shapes-1">
                                                    <div class="team-single-img">
                                                        <a
                                                            @if (!empty($teams->slug)) href='{{ url($teams->slug) }}' @endif>
