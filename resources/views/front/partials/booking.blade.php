                                ...
                                <form method="post" class="contact-validation-active" id="consultancy-form">
                                    <div class="row">
                                        <div class="form-field col-lg-6">
                                            <input class="form-control-name " type="text" placeholder="Full Name" name="name" id="name">
                                        </div>
                                        <div class="form-field col-lg-6">
                                            <input class="form-control-mail" type="email" placeholder="Email" name="email" id="email">
                                        </div>
                                        <div class="form-field col-lg-6">
                                            <input class="form-controls form-control-number " name="phone" type="tel" placeholder="Phone No.">
                                        </div>
                                        <div class="form-control-age form-field col-lg-3">
                                            <input class="form-controls form-control-number" name="age" type="text" id="age" placeholder="Age">
                                        </div>
                                        <div class="form-controls form-control-gender form-field col-lg-3">

                                            <select name="gender" class="form-control valid" aria-required="true" aria-invalid="false">
                                        ...
                                        <div class="form-control-age form-field col-lg-6">
                                            <div class="form-controls form-control-choose-department">
                                                <select name="department" class="form-control valid" aria-required="true" aria-invalid="false">
                                                    <option value="0" disabled="disabled" selected="">Choose Department
                                                    </option>
                                        ...
                                        <div class="col-xl-7 col-lg-12 col-12">
                                            <div class="submit-area">
                                                <button type="submit" class="theme-btn">Book Appoinment</button>
                                                <div id="loader">
                                                    <i class="ti-reload"></i>
                                                </div>
                                            </div>
