(function ($) {
    ...
    /*------------------------------------------
       wpo-speciality-slider
    -------------------------------------------*/
    if ($(".speciality-service-slider").length) {
        $(".speciality-service-slider").owlCarousel({
			...
			autoplay: 4000,
			autoplayHoverPause: true,
			navText: [ '<span><img src="assets/images/icon/arrow-left.svg"   /></span>', '<span><img src="assets/images/icon/arrow-right.svg" /></span>' ],
			responsive:{
                0: {
                    items: 1.3,
                    dots: true,
    ...
    if ($("#contact-form-main").length) {
        $("#contact-form-main").validate({
            ...
            messages: {
                ...
                note: "Please enter your massage",
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 50) {
       $('.wpo-site-header').addClass('newClass');
    } else {
       $('.wpo-site-header').removeClass('newClass');
    }
});
